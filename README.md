...
## Preparation
1) DATASET  
  a) create a folder (for example, /home/dooseop/DATASET/) and copy the driving sequence folders listed in './dataset/train.txt' and './dataset/test.txt' to the created folder. (link: ----) 
